...
from test import test, from_gym
import sys
...
parser.add_argument('--game', type=str, default='SpaceInvadersNoFrameskip-v4', help='ATARI game')
...
if __name__ == '__main__':
    ...
    # Environment
    env = wrap_deepmind(gym.make(args.game), dim=84)
    ...
    while T < args.evaluation_size - args.history_length + 1:
      if done:
        state, done = from_gym(env.reset()), False
